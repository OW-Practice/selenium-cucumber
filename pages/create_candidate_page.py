...
from locators.create_candidate_locators import CandidateInfoLocators
...
class CandidateInfoPage(BasePage,SynMethods,CandidateInfoLocators):
    ...
    def verify_confirmation_pop_up(self):
        ...
        assert confirmation_pop_up.is_displayed() == True, "confirmation pop up is not displayed"
    ...
    def verify_text_in_confirmation_pop_up(self):
        ...
        assert confirmation_text.is_displayed() == True, "confirmation text is not displayed"
    ...
    def click_on_add_candidate_check_box(self,f_name,l_name):
        loc = (By.XPATH, "//*[text()='" + f_name + ", " + l_name + "']/ancestor::tr[3]//label")
