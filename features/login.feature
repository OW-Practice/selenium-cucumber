Feature: Student Registration
  ...
  Scenario:
    ...
    Then Validate job requisitions header
    ...
    When Enter candidate details in to fields
    ...
    Then Validate yes and no buttons on confirmation popup
      ...
      | Yes        |
      | No         |
    Then Click on yes button in confirmation popup "Yes"
